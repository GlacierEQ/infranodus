...
CypherQuery.addStatement = function(
    ...
    for (var sindex = 0; sindex < params['statements'].length; sindex++) {
        ...
        // Optimization: Replace array-based deduplication with Set for O(1) lookups
        // Create a Set to store the already added Nodes to avoid duplicates in Cypher MERGE query for Concepts
        var concepts_added = new Set()

        // Create a Set to store the already added Mentions to avoid duplicates in Cypher MERGE query for Mentions
        ...
        if (params['statements'][sindex]['mentions']) {
            ...
            for (
                ...
                if (
                    ...
                    // Add the mention we just added into the Set to check for duplicates in the next cycle
                    mentions_added.add(
                        params['statements'][sindex]['mentions'][puka]
                    )
    ...
    // Optimization: Remove expensive JSON.stringify logging of large objects
