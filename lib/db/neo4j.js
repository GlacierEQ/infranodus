...
CypherQuery.addStatement = function(
    ...
    for (var sindex = 0; sindex < params['statements'].length; sindex++) {
        ...
        // Optimization: use Sets to store added Concepts and Mentions for O(1) deduplication instead of O(N) array searches.
        // This significantly speeds up processing of large statements with many duplicate concepts.
